...
class TrackingApi
{
    ...
    /**
     * Operation controllersTrackingGet
     *
    ...
    {
        list($response) = $this->controllersTrackingGetWithHttpInfo($dldclck_id);
        return $response;
    }

    /**
     * Operation controllersTrackingGetWithHttpInfo
     *
     * Get tracking by its id
     *
     * @param string $dldclck_id ID of Dolead click (required)
    ...
    {
        // verify the required parameter 'dldclck_id' is set
        if ($dldclck_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $dldclck_id when calling controllersTrackingGet');
        }
        // parse inputs
        $resourcePath = "/tracking/{dldclck_id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        if ($dldclck_id !== null) {
            $resourcePath = str_replace(
                "{" . "dldclck_id" . "}",
                $this->apiClient->getSerializer()->toPathValue($dldclck_id),
                $resourcePath
            );
        }

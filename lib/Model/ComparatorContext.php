...
/**
 * ComparatorContext Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Dcm
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ComparatorContext implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ComparatorContext';
    ...
    /**
     * Sets category
     * @param string $category Lead universe ID
     * @return $this
     */
    ...
    /**
     * Sets form_id
     * @param string $form_id Lead form ID
     * @return $this
     */
    ...
    /**
     * Sets offer_id
     * @param string $offer_id Offer ID in DUX
     * @return $this
     */
